        ...
        content = { innerPadding ->
            ...
            Column(
                ...
                Row(
                    ...
                    StyledButton(
                        text = "Todos",
                        onClick = { selectedSection = "todos" },
                        isSelected = selectedSection == "todos",
                        modifier = Modifier.weight(1f)
                    )
                    Spacer(modifier = Modifier.width(10.dp))
                    StyledButton(
                        text = "Alertas",
                        onClick = { selectedSection = "alertas" },
                        isSelected = selectedSection == "alertas",
                        modifier = Modifier.weight(1f)
                    )
                    Spacer(modifier = Modifier.width(10.dp))
                    StyledButton(
                        text = "Mensajes",
                        onClick = { selectedSection = "mensajes" },
                        isSelected = selectedSection == "mensajes",
                        modifier = Modifier.weight(1f)
                    )
                }
